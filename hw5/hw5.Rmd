...
```{r}
Ver_Euclidean<-as.matrix(dist(vertebrate[,2:7])) #omit 1st and 8th columns, contain text
...
I like the Euclidean distance since it interprets distances like they are in actual space, and the distances are more unique (Manhattan distance yields a lot of distances that are the same, leading to a flat-looking dendrogram).  
