Cluster_Ex<-read.csv("C:/Users/gehmand/OneDrive - Carlisle Area School District/Desktop/Data 180 dTomGehman/DATA180/Today's Class Oct 26/Cluster_ex.csv") #"Path where your data is goes here"
ls(Cluster_Ex)
head(Cluster_Ex)
...
Cluster_Ex_HC<-hclust(dist(Cluster_Ex))
cutree(Cluster_Ex_HC,k=3) #cut dendrogram by no of clusters (3)
...
Cluster_Ex<-read.csv("C:/Users/gehmand/OneDrive - Carlisle Area School District/Desktop/Data 180 dTomGehman/DATA180/Today's Class Oct 26/Cluster_Ex_clusters.csv")
