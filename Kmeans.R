Cluster_Ex<-read.csv("C:/Users/gehmand/OneDrive - Carlisle Area School District/Desktop/Data 180 dTomGehman/DATA180/Cluster_Ex.csv") # The path to your data goes here. 
head(Cluster_Ex)
